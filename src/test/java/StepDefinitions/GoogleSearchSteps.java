...
public class GoogleSearchSteps {
	 ...
	 * 
	 * @Given("browser window is open") public void browser_is_open() {
	 * 
	 ...
	 * projectPath+"C:/Program Files/Mozilla Firefox/firefox.exe");
	 * 
	 ...
	 * 
	 * driver.findElement(By.name("q")).sendKeys(Keys.ENTER); Thread.sleep(2000); }
	 * 
...
//
//		System.setProperty("webdriver.firefox.driver",
//				projectPath + "C:/selenuim_git/SeleniumCucumberBDD/CucumberJava/src/test/resources/drivers/geckodriver.exe");
//		driver = new FirefoxDriver();
//		driver.manage().timeouts().implicitlyWait(40, TimeUnit.SECONDS);
//		driver.manage().timeouts().implicitlyWait(40, TimeUnit.SECONDS);
//
